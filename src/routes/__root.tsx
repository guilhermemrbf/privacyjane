...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Privacy | Jane" },
      { property: "og:description", content: "Acesso ao conteúdo exclusivo." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Privacy | Jane" },
      { name: "twitter:description", content: "Acesso ao conteúdo exclusivo." },
